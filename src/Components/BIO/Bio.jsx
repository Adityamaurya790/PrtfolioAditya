...
export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/11IkFSCSSIeHgLy-W1ugYC79LK5fHsyZG/view?usp=drive_link",
...
export const skills = [
  {
    ...
    skills: [
      {
        name: "React Js",
        image: "src/Components/Assets/images/react.png",
      },
  ...
  },
  {
    ...
    skills: [
      {
        name: "Node Js",
        image: "src/Components/Assets/images/node.png",
      },
      {
        name: "Express Js",
        image:
    ...
    skills: [
      {
        name: "Docker",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgxK54uluJ_3i1hiVxxNBDuOnn_l4RfHLfXuG0YrzRso5iDJw5k0vCZqs&usqp=CAE&s",
      },
      {
        name: "Kubernetes",
        image: "src/Components/Assets/images/Kubernetes.png",
      },
      {
        name: "Git",
        image:
