...
const Skills = () => {
  return (
    <div
      id="skills"
      className="flex justify-center items-baseline relative bg-gray-900"
    >
      <div className="relative flex flex-col items-center w-full max-w-5xl gap-3 text-white">
        ...
        <div className="w-full flex flex-wrap mt-7 gap-7 justify-center">
          {skills.map((skill) => (
            <div
              key={skill.title}
              className="bg-card border border-purple-500 shadow-lg rounded-lg p-5 hover:-translate-y-1 transition-all duration-300 ease-in-out hover:shadow-xl sm:w-full md:w-[48%] lg:w-[30%]"
            >
